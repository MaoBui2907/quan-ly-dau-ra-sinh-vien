...
(function ($jq) {
    ...
    $jq.fn.extend({
        table2csv: function (options) {
            ...
            options = $jq.extend(default_options, options);
            init(this, options);
        }
    })
})(jQuery);
